...
```
cd existing_repo
git remote add origin https://git.chas-lab.dev/chas-challenge-2026/grupp-15/zero-bug-heroes/zero-bug-heroes.git
git branch -M main
...
- [Set up project integrations](https://git.chas-lab.dev/chas-challenge-2026/grupp-15/zero-bug-heroes/zero-bug-heroes/-/settings/integrations)
