  ...
  return (
    <div className="w-full min-h-screen bg-background flex flex-col">
      ...
      <button
        ...
        className={`fixed bottom-40 right-6 z-50 size-12 rounded-full bg-card shadow-lg outline outline-1 outline-border flex justify-center items-center transition-[opacity,transform] duration-200 hover:scale-105 ${
          showScrollTop
