    ...
    >
      <div className="flex w-full items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <div className="font-['DM_Sans'] text-base font-semibold text-foreground">{name}</div>
          ...
          <p className="mt-1 line-clamp-2 font-['DM_Sans'] text-sm font-normal text-Colors-muted-foreground">{preview}</p>
        </div>
        <div className="shrink-0 pt-0.5 font-['DM_Sans'] text-xs font-medium text-Colors-muted-foreground">{timeLabel}</div>
      </div>
    </button>
  );
}
